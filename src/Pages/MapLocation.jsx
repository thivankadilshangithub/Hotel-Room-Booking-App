...
const Destination = () => {
  ...
  const festivalsData = [
    ...
    },
    {
      ...
      description:
        "Immerse yourself in the enchanting Winter Land festival, transforming Grooveville in Saudi Arabia into a magical wonderland. Delight in the best of global music, surrounded by the crisp winter air. With dazzling lights and an array of performances, Winter Land promises an extraordinary experience that captures the spirit of the season.",
      image: winterland,
    },
    {
      id: 3,
      ...
      description:
        "Heritage Town in Saudi Arabia becomes a melting pot of diversity during the Boulevard World event. Celebrate the richness of various cultures through captivating art exhibitions, delectable international cuisines, and mesmerizing performances. Boulevard World is a journey around the globe, bringing people together in a harmonious celebration of unity.",
      image: boulevard,
    },
    {
      id: 4,
    ...
    },
    {
      ...
      description:
        "Maplewood in Saudi Arabia roars to life with the adrenaline-pumping excitement of Formula 1. Experience the beauty of autumn with high-speed thrills, captivating races, and a festival of automotive excellence. Formula 1 in Saudi Arabia is not just a race; it is a celebration of precision, speed, and the passion for cutting-edge technology in the world of motorsports.",
      image: formula1,
    },
  ];
  ...
  const [viewPort, setViewPort] = useState({
    latitude: 24.72142873518393,
    longitude: 46.6711565259167,
    zoom: 6,
  });

    const handleSeeOnMap = (festivalId) => {
      // Find the festival with the corresponding id
      const selectedFestival = festivalsData.find(
      ...
      if (selectedFestival) {
        ...
        // Set the viewport to center on the selected location
        setViewPort({
          latitude: selectedFestival.latitude,
          longitude: selectedFestival.longitude,
        ...
        // Check if mapRef is not null before trying to access its properties
        if (mapRef.current) {
          // Scroll to the map section
          mapRef.current.scrollIntoView({ behavior: "smooth" });
        }
  
        // Log the selected festival details
  ...
  const handleWheel = (event) => {
    ...
    const scale = 0.8; // You can adjust this value to control the zoom speed
    const deltaY = event.deltaY;
    const newZoom = viewPort.zoom - deltaY / 100 * scale;
  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: "60px", marginLeft: "70px" }} >
        <div ref={mapRef} onWheel={handleWheel} >
          <Map
          ...
          >
            <img
              ...
              style={{
                ...
                objectFit: "cover",
                borderRadius:
                  festival.id % 2 === 1 ? "8px 0 0 8px" : "0 8px 8px 0",
                pointerEvents: "none",
              }}
            />
            <div style={{ flex: 1, padding: "20px" }}>
              ...
              <p
                style={{ color: "#777", fontSize: "14px", fontStyle: "italic" }}
              >
                {festival.startDate}
              </p>
              <p
